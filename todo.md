...
- [ ] Restore the polished clinical PDF report layout while retaining the resilient export fallback and validate it against the clinician-provided reference PDF.
